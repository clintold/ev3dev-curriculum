...
# Also someone should update the libs/mqtt_remote_method_calls.py file on the robot too (at some point before Mazanyap).
...
def left_mouse_click(event, mqtt_client):
    ...
    my_color = "maroon"  # Make your color unique
